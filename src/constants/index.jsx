...
export const MAIN_DISHES = [
  ...
  {
    image: placeholder,
    title: "Crispy Chicken Wings (6 pieces)",
    description: "Perfectly seasoned chicken wings fried to golden perfection.",
    price: "15",
  },
  {
    image: placeholder,
  ...
  {
    image: "./photos/falafelPlates.jpg",
