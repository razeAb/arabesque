...
import { DISHESTEXT, LINK, LIST, ARABESQUE_BREAKFAST, HEALTHY_DISHES, MAIN_DISHES, PIZZA, COLD_DRINKS } from "../constants";
  ...
  return (
    <section id="menu" className="container flex flex-col items-center mx-auto py-16">
      <div className="m-5 md:m-10">
        <h1 className="font-Geist font-bold mb-8 tracking-wider text-center">{LIST.list2}</h1>

        <p className="font-Geist tracking-wider text-center dark:text-seconadryText">{DISHESTEXT.description}</p>
